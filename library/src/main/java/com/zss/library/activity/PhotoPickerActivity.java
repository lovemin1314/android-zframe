...
import com.zss.library.photopicker.adapter.FolderAdapter;
import com.zss.library.photopicker.adapter.PhotoAdapter;
...
import com.zss.library.utils.SdCardUtils;
...
public class PhotoPickerActivity extends BaseActivity implements PhotoAdapter.PhotoClickCallBack {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (!SdCardUtils.isSdCardAvailable()) {
            CommonToastUtils.showInCenterToast(this, "No SD card!");
            return;
        }
    ...
    public void setTopBar() {
        ...
        toolbar.setTitle(getString(R.string.photos_title));
        ...
        if(mSelectMode == MODE_MULTI) {
            ...
            mMenuBtn = toolbar.getRightMenu();
            mMenuBtn.setVisibility(View.VISIBLE);
            mMenuBtn.setEnabled(false);
            mMenuBtn.setText(R.string.confirm);
    ...
    private void getPhotosSuccess() {
        ...
        mPhotoNumTV.setText(getString(R.string.photos_num, mPhotoLists.size()));
    ...
    public void onPhotoClick() {
        ...
        if(list != null && list.size()>0) {
            ...
            mMenuBtn.setText(getString(R.string.commit_num, list.size(), mMaxNum));
        } else {
            mMenuBtn.setEnabled(false);
            mMenuBtn.setText(R.string.confirm);
        }
    ...
    private void initAnimation(View dimLayout) {
         ...
         */
        int height = DPUtils.getScreenH(this) - 3 * actionBarHeight;
    ...
    private void showCamera() {
        ...
        if(cameraIntent.resolveActivity(getPackageManager()) != null){
            ...
            CommonToastUtils.showInCenterToast(getApplicationContext(),
