package com.zss.library.photopicker.adapter;
...
import com.zss.library.photopicker.utils.ImageLoader;
...
public class PhotoAdapter extends BaseAdapter {
    ...
    public PhotoAdapter(Context context, List<Photo> mDatas) {
        ...
        int screenWidth = DPUtils.getScreenW(mContext);
        mWidth = (screenWidth - DPUtils.dip2px(mContext, 4))/3;
    }
            ...
            public void onClick(View v) {
                ...
                if(mSelectedPhotos.contains(path)) {
                    ...
                    if(mSelectedPhotos.size() >= mMaxNum) {
                        CommonToastUtils.showInCenterToast(mContext, mContext.getString(R.string.msg_maxi_capacity));
                        return;
                    }
